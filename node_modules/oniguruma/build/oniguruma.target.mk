...
TARGET := oniguruma
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=oniguruma' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/oniguruma.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/oniguruma.a: LIBS := $(LIBS)
$(builddir)/oniguruma.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/oniguruma.a: TOOLSET := $(TOOLSET)
$(builddir)/oniguruma.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)
...
.PHONY: oniguruma.a
oniguruma.a: $(builddir)/oniguruma.a
